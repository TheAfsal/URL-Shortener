    ...
    return (
        <Card className="gradient-card mt-8">
            <CardHeader>
                ...
                <CardDescription className="text-blue-300">Manage all your shortened links in one place</CardDescription>
            </CardHeader>
            <CardContent>
                {isLoading ? (
                    <div className="text-center py-8 text-blue-300">Loading...</div>
                ) : urls.length === 0 ? (
                    <div className="text-center py-8 text-blue-300">You haven't created any shortened URLs yet</div>
                ) : (
